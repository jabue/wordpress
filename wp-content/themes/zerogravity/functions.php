...
function zerogravity_scripts_styles() {
	...
	// Custom style
	wp_enqueue_style('zerogravity-custom-style', get_template_directory_uri()."/custom-style.css");
	...
	// Toggle search
	wp_enqueue_script('zerogravity-toggle-search', get_template_directory_uri() .'/js/zg-toggle-search.js', array('jquery'), ZEROGRAVITY_VERSION, true);
}
