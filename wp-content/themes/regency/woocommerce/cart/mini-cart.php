...
<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
    ...
    <p class="buttons">
        <a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward btn-ghost"><?php _e( 'View Cart', 'yit' ); ?></a>
        <a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="button checkout wc-forward btn-flat"><?php _e( 'Checkout', 'yit' ); ?></a>
    </p>
