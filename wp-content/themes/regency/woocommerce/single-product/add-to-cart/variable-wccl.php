    ...
    <?php else : ?>
            <ul class="variations" cellspacing="0">
                ...
                <?php foreach ( $attributes as $name => $options ) : ?>
                    ...
                    <li>
                        <label for="<?php echo sanitize_title( $name ); ?>"><?php echo $wc_attribute_label_name; ?></label>
                    <select id="<?php echo esc_attr( sanitize_title($name) ); ?>" name="<?php echo 'attribute_' . esc_attr( sanitize_title( $name ) ) ?>" data-attribute_name="attribute_<?php echo esc_attr( sanitize_title( $name ) ) ?>" data-type="<?php echo $attributes_types[$name] ?>">
                        ...
                        <?php echo end( $attribute_keys ) === $name ? '<a class="reset_variations" href="#">' . __( 'Clear selection', 'woocommerce' ) . '</a>' : ''; ?>
                    </li>
                <?php endforeach;?>
            </ul>
