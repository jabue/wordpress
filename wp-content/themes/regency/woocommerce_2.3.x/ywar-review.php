		...
		<div class="comment-text arrow-left">
			...
			<?php else : ?>
                ...
                <div class="meta">
                    ...
                    <p itemprop="author"><?php echo $author_name; ?></p> <?php
                    ...
                    <?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>
                        ...
                        <div class="woocommerce-product-rating" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" title="<?php echo sprintf( __( 'Rated %d out of 5', 'woocommerce' ), $rating ) ?>">
