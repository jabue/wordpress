...
if ( $rating_count > 0 ) :
    ...
    <div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
        ...
        if( is_quick_view() ) {
            ...
            echo "<a href='#reviews' class='woocommerce-review-link a-style-2' rel='nofollow'> <span itemprop='reviewCount'>" . $rating_count . " </span>" . _n( "review", "reviews", $review_count, "yit" ) . " </a>";
        }
        ?>
