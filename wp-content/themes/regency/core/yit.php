 ...
 * Core folder url
 */
!defined( 'YIT_CORE_PLUGIN_PATH' ) && define( 'YIT_CORE_PLUGIN_PATH', YIT_CORE_PATH . '/plugin-fw' );

/**
 * Core folder url
 */
!defined( 'YIT_CORE_PLUGIN_URL' ) && define( 'YIT_CORE_PLUGIN_URL', YIT_CORE_URL . '/plugin-fw' );
