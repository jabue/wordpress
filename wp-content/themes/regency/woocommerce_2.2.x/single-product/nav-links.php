...
$prev = get_previous_post_link( '%link', '<span class="icon-wrap">' . __("Prev", "yit" ) . '</span>' . $prev_post_content, $in_category, $excluted_terms, 'product_cat' );
$next = get_next_post_link( '%link', '<span class="icon-wrap">'. __("Next", "yit" ) . '</span>' . $next_post_content , $in_category, $excluted_terms, 'product_cat' );
