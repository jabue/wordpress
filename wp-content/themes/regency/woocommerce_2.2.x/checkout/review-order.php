...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<div id="payment">
        <h3><?php _e('Payment Methods', 'yit'); ?></h3>
			...
			<?php
				...
				if ( ! empty( $available_gateways ) ) {
					...
					if ( ! WC()->customer->get_country() )
						$no_gateways_message = __( 'Please fill in your details above to see available payment methods.', 'yit' );
					else
						$no_gateways_message = __( 'Sorry, it seems that there are no available payment methods for your state. Please contact us if you require assistance or wish to make alternate arrangements.', 'yit' );
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="btn btn-flat" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
