           ...
           // var_dump($instance);
            ...
            if ( is_user_logged_in() && $show_logged_in == 'yes' ) {
                ...
                <div id="welcome-menu" class="nav dropdown">
                    <ul>
                        <li class="menu-item dropdown"><a href="#"><span class="welcome_username"><?php echo  __('Hi', 'yit') ?> <?php  echo apply_filters( 'yit_welcome_username', $user_name ) ?></span> </a>
                        <?php
                ...
                <div id="welcome-menu-login" class="nav">
                    <ul id="menu-welcome-login">
                        <li class="menu-item login-menu">
                            <a href="<?php echo esc_url( $profile_link ) ?>"><?php echo $title_logged_out ?><span class="sf-sub-indicator fa fa-angle-down"> </span></a>
                                ...
                                <div class="clearfix login-box <?php echo $enabled_registration_class ?>">
                                    ...
                                    <div class="customer-login-box customer-login-box1">
                                        <h4><?php _e( 'Login', 'yit' ); ?></h4>
                                            <form method="post" class="login">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="username" id="username" value="<?php if ( ! empty( $_POST['username'] ) ) esc_attr( $_POST['username'] ); ?>"/>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="customer-login-box customer-login-box2">
                                            ...
                                            <h4><?php _e( 'Create your account', 'yit' ); ?></h4>
                                            ...
                                            <form method="post" class="register" id="login-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="submit" class="button button-register btn-ghost" name="register" value="<?php _e( 'Register', 'yit' ); ?>" />
                                                </div>
            ...
            if( $nav_show_wishlist ): ?>
                <div class="nav whislist_nav">
                    <ul>
                        <li>
                            <a href="<?php echo wc_get_endpoint_url('wishlist', '',  get_permalink( wc_get_page_id( 'myaccount' ) ) ) ?>"><?php  _e('Wishlist', 'yit') ?></a>
                        </li>
                    </ul>
                </div>
            <?php endif;
