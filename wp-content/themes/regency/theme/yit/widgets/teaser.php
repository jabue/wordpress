...
if ( ! class_exists( 'teaser' ) ) :
    class teaser extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'slogan_color' ); ?>"><?php _e( 'Slogan Color hex code', 'yit' ) ?> - <small>i.e. #ffffff</small></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'slogan_color' ); ?>" name="<?php echo $this->get_field_name( 'slogan_color' ); ?>" value="<?php echo $instance['slogan_color']; ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'slogan_size' ); ?>"><?php _e( 'Slogan Size in px', 'yit' ) ?></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'slogan_size' ); ?>" name="<?php echo $this->get_field_name( 'slogan_size' ); ?>" value="<?php echo $instance['slogan_size']; ?>" />
            </p>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'subslogan_color' ); ?>"><?php _e( 'Subslogan Color hex code', 'yit' ) ?> - <small>i.e. #ffffff</small></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'subslogan_color' ); ?>" name="<?php echo $this->get_field_name( 'subslogan_color' ); ?>" value="<?php echo $instance['subslogan_color']; ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'subslogan_size' ); ?>"><?php _e( 'Subslogan Size in px', 'yit' ) ?></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'subslogan_size' ); ?>" name="<?php echo $this->get_field_name( 'subslogan_size' ); ?>" value="<?php echo $instance['subslogan_size']; ?>" />
            </p>
            ...
            <p>
                ...
                <select id="<?php echo $this->get_field_id( 'slogan_position' ); ?>" name="<?php echo $this->get_field_name( 'slogan_position' ); ?>">
                    ...
                    <option value="top right" <?php selected( $instance['slogan_position'], 'top right' ) ?>><?php _e( 'Top right', 'yit' ) ?></option>
                    ...
                    <option value="center right" <?php selected( $instance['slogan_position'], 'center right' ) ?>><?php _e( 'Center right', 'yit' ) ?></option>
                    ...
                    <option value="bottom right" <?php selected( $instance['slogan_position'], 'bottom right' ) ?>><?php _e( 'Bottom right', 'yit' ) ?></option>
                    <option value="bottom center" <?php selected( $instance['slogan_position'], 'bottom center' ) ?>><?php _e( 'Bottom center', 'yit' ) ?></option>
                </select>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Label Button', 'yit' ) ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_style' ); ?>"><?php _e( 'Button Style', 'yit' ); ?></label>
                <select id="<?php echo $this->get_field_id( 'button_style' ); ?>" name="<?php echo $this->get_field_name( 'button_style' ); ?>">
                    <option value="flat" <?php selected( $instance['button_style'], 'flat' ) ?>><?php _e( 'Black Flat', 'yit' ) ?></option>
                    <option value="ghost" <?php selected( $instance['button_style'], 'ghost' ) ?>><?php _e( 'Ghost Black', 'yit' ) ?></option>
                    <option value="ghost-white" <?php selected( $instance['button_style'], 'ghost-white' ) ?>><?php _e( 'Ghost White', 'yit' ) ?></option>                 
                    <option value="ghost-red right" <?php selected( $instance['button_style'], 'ghost-red' ) ?>><?php _e( 'Ghost Red', 'yit' ) ?></option>
                    <option value="ghost-grey" <?php selected( $instance['button_style'], 'ghost-grey' ) ?>><?php _e( 'Ghost Grey', 'yit' ) ?></option>
                </select>
            </p>
