        ...
        function form( $instance )
        {
            ...
            <p>
                <label><?php _e( 'Address', 'yit' ) ?>:
                    <textarea id="<?php echo $this->get_field_id( 'address' ); ?>" name="<?php echo $this->get_field_name( 'address' ); ?>"><?php echo $instance['address']  ?></textarea>
                </label>
            </p>
            ...
            <p>
                <label><?php _e( 'Phone', 'yit' ) ?>:
                    <textarea id="<?php echo $this->get_field_id( 'phone' ); ?>" name="<?php echo $this->get_field_name( 'phone' ); ?>"><?php echo $instance['phone']  ?></textarea>
                </label>
            </p>
            ...
            <p>
                <label><?php _e( 'Mobile', 'yit' ) ?>:
                    <textarea id="<?php echo $this->get_field_id( 'mobile' ); ?>" name="<?php echo $this->get_field_name( 'mobile' ); ?>"><?php echo $instance['mobile']  ?></textarea>
                </label>
            </p>
            ...
            <p>
                <label><?php _e( 'Fax', 'yit' ) ?>:
                    <textarea id="<?php echo $this->get_field_id( 'fax' ); ?>" name="<?php echo $this->get_field_name( 'fax' ); ?>"><?php echo $instance['fax']  ?></textarea>
                </label>
            </p>
            ...
            <p>
                <label><?php _e( 'Email Text', 'yit' ) ?>:
                    <textarea id="<?php echo $this->get_field_id( 'email_text' ); ?>" name="<?php echo $this->get_field_name( 'email_text' ); ?>"><?php echo $instance['email_text']  ?></textarea>
                </label>
            </p>
