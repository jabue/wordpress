...
class YIT_Recent_Posts extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'show_compact' ); ?>"><?php _e( 'Show Compact Layout', 'yit' ) ?>:
                <select id="<?php echo $this->get_field_id( 'show_compact' ); ?>" name="<?php echo $this->get_field_name( 'show_compact' ); ?>">
