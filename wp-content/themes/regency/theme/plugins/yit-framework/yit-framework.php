...
class YIT_Framework {
	...
	public function add_admin_modules_page() {
		add_submenu_page( 'yit_panel', __( 'YIT Framework Modules', 'yit-framework' ), __( 'Modules', 'yit-framework' ), 'install_plugins', 'yit-framework-modules', array( $this, 'admin_modules_page' ) );
	}
