...
return array(
    ...
    array(
        ...
        'desc'         => __( '<strong>Warning: You must import export file before customizing your theme.</strong>
                               ...
                               <br/><br/>
                               Inside the package you have downloaded from ThemeForest, you will find a <strong>sample data folder</strong> containing all the files:
                               choose the skin you want and upload it to manually import it.
