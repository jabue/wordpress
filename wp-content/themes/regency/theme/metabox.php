                ...
                'tabs'     => array(
                    'settings'        => array( //tab
                        ...
                        'fields' => array(
                            ...
                            'slogan_border'      => array(
                                'label' => __( 'Enable slogan border', 'yit' ),
                                'desc'  => __( 'Set YES if you want to customize the border of slogan', 'yit' ),
                                'type'  => 'onoff',
                                'std'   => 'yes',
                                'deps'  => array(
                                    'ids'    => '_show_slogan',
                            ...
                            'slogan_border_color'       => array(
                                'label' => __( 'Slogan border color', 'yit' ),
                                'desc'  => __( 'Select a color for the border of slogan', 'yit' ),
                                'type'  => 'colorpicker',
                                'std'   => '#ffffff',
                                'deps'  => array(
                                    'ids'    => '_slogan_border',
                    ...
                    'header'          => array(
                        ...
                        'fields' => array(
                            ...
                            'enable_dark_header'      => array(
                                'label' => __( 'Enable style for dark header', 'yit' ),
                                'desc'  => __( 'Set YES to change the style of typography in header, useful if you are using the trasparent header and you have a dark static image.', 'yit' ),
                                'type'  => 'onoff',
                                'std'   => 'no'
                            )
                        ),
                    ...
                    'google_map' => array(
                        ...
                        'fields' => array(
                            ...
                            'google_map_full_width'        => array(
                                'label' => __( 'Full Width', 'yit' ),
                                'type'  => 'onoff',
                                'std'   => 'yes'
                            ),
                            'google_map_width'             => array(
                                'label' => __( 'Width', 'yit' ),
                                'desc'  => __( 'set the width for the google map', 'yit' ),
                                'type'  => 'text',
                                'std'   => '',
                                'deps'  => array(
                                    'ids'    => '_google_map_full_width',
                                    'values' => 'no'
                                )
                            ),
                            'google_map_height'            => array(
                                'label' => __( 'Height', 'yit' ),
                                'desc'  => __( 'set the height for the google map', 'yit' ),
                                'type'  => 'text',
                                'std'   => ''
                            ),
                            ...
                            'google_map_overlay_address'   => array(
                                ...
                                'desc'  => __( 'set the address (like "1600 Amphitheatre Parkway, Mountain View, CA" )', 'yit' ),
                                'type'  => 'text',
                                'std'   => ''
                            ),
                            'google_map_overlay_latitude'  => array(
                                'label' => __( 'Latitude', 'yit' ),
                                'desc'  => __( 'set the latitude', 'yit' ),
                                'type'  => 'text',
                                'std'   => ''
                            ),

                            'google_map_overlay_longitude' => array(
                                'label' => __( 'Longitude', 'yit' ),
                                'desc'  => __( 'set the longitude', 'yit' ),
                                'type'  => 'text',
                                'std'   => ''
                            ),

                            'google_map_overlay_zoom'      => array(
                                'label' => __( 'Zoom of map', 'yit' ),
                                'desc'  => __( 'Set the zoom of map (0-19)', 'yit' ),
                                'type'  => 'number',
                                'std'   => '15',
                                'min'   => '0',
                                'max'   => '19'
                            ...
                            'google_map_overlay_marker'    => array(
                                'label' => __( 'Marker image', 'yit' ),
                                'desc'  => __( 'upload a image for the marker', 'yit' ),
                                'type'  => 'upload',
                                'std'   => ''
                            ),

                            'google_map_overlay_style'     => array(
                                'label'   => __( 'Style of map', 'yit' ),
                                'desc'    => __( 'Selectthe style of map', 'yit' ),
                                'type'    => 'select',
                                'options' => array(
                                    'color' => __( 'Color', 'yit' ),
                ...
                'tabs'     => array(
                    'settings' => array( //tab
                        ...
                        'fields' => array(
                            ...
                            'add_extra_content' => array(
                                'label' => __( 'Add Extra Content', 'yit' ),
                                'desc' => __( 'Add extra content to product page', 'yit' ),
                                'type' => 'onoff',
                                'std' => 'no'
                            ),
                            'extra_content' => array(
