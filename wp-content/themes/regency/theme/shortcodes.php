    ...
    'box_section' => array(
        ...
        'attributes' => array(
            ...
            'icon_type' => array(
                ...
                'type'  => 'select',
                'options' => array(
                    'awesome'     => __( 'Awesome Icon', 'yit' ),
                    'simple_line' => __( 'Simple Line Icon', 'yit' ),
            ...
            'icon_simple_line' => array(
                'title' => __('Icon', 'yit'),
                'type' => 'select-icon',  // home|file|time|ecc
                'options' => $simple_line_icons,
            ...
            'color_circle_simple_line' => array(
                'title' => __('Border Color Icon', 'yit'),
                'type' => 'colorpicker',
                'std'  => '#797979',
                'deps' => array(
    ...
    $shop_shortcodes = array(
        ...
        'products_tabs' => array(
            ...
            'attributes' => array(
                ...
                'layout_1' => array(
                    'title' => __('Products Layout', 'yit' ),
                    'type' => 'select',
                    'options' => array(
                        'default' => __('Default Layout', 'yit' ),
                        'elegant' => __('Elegant Layout', 'yit' ),
                        'alternative' => __('Alternative Layout', 'yit' )
                    ),
                    'std' => 'default',
                    'multiple' => true
                ),
