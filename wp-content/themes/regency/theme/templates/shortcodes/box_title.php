...
switch ( $border ):
    ...
    case 'middle':
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate. $vc_css . ' '. $border ?> box-title-line-middle wrap-title <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $animate_data ?>>
            <div class="title-bar">
    ...
    default:
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate . ' ' . $border ?> box-title-line-none <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $animate_data ?>>
            <h2 style="<?php echo $title_style ?>">
                <?php echo yit_decode_title( do_shortcode( $content ) ) ?>
            </h2>
            <?php if( $subtitle != '' ):?>
