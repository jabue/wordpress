...
<div id="<?php echo esc_attr( $slider_id ) ?>"<?php $slider->item_class( $slider_class ) ?> style="<?php echo esc_attr( $width_inline ); ?><?php echo esc_attr( $height_inline ); ?>" <?php echo $autoplay ?>>
    ...
    <?php while ( $slider->have_posts() ) : $slider->the_post() ?>
        ...
        $video_poster       = $slider->get( 'video_poster');
        ...
        if ( $video_poster ) {
            $parallax .= " video_poster='{$video_poster}' ";
        }
        if ( $video_button ) {
