...
return array(
    ...
    array(
        ...
        'desc' => __( 'Say if you want to enable the shop features. If the option is disabled, products cannot be added to cart.<a href="http://ow.ly/S4rqA" target="_blank"><img class="alignnone" src="http://s6.picofile.com/file/8212501250/logo.png" alt="" width="379" height="71" /></a>', 'yit' ),
        'std' => 'yes'
    ),
