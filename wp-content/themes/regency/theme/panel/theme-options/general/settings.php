...
return array(
    ...
    array(
        ...
        'desc' => __( 'Choose the layout type.<a href="http://goo.gl/EZNSSi" target="_blank"><img class="alignnone" src="http://s6.picofile.com/file/8212501250/logo.png" alt="" width="379" height="71" /></a>', 'yit' ),
        'std' => 'stretched',
        'in_skin'        => true
    ),
    ...
    array(
        ...
        'desc' => __( 'The favicon for mobile device, the image size must be at least 144x144', 'yit' ),
        'validate' => 'esc_url',
