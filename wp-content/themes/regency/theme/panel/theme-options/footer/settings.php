...
return array(
    ...
    array(
        ...
        'std' => 'Copyright '. date('Y').' - Regency Shop by Your Inspiration Themes',
        'deps' => array(
            'ids' => 'footer-type',
    ...
    array(
        ...
        'std' => 'Regency - '. date('Y').' by  Your Inspiration Themes',
        'deps' => array(
            'ids' => 'footer-type',
    ...
    array(
        ...
        'std' => '[credit_card type="western-union, paypal-1, visa, amazon, direct-debit, google, mastercard, maestro, moneygram "]',
        'deps' => array(
            'ids' => 'footer-type',
            'values' => 'normal,big-normal'
        )
