...
if ( ! function_exists( 'yit_button_style' ) ) {
    ...
    function yit_button_style( $button = array() ) {
        $button['flat']        = __( 'Black Flat', 'yit' );
        $button['ghost']       = __( 'Ghost Black Button', 'yit' );
        $button['ghost-white'] = __( 'Ghost White Button', 'yit' );
        $button['ghost-red']   = __( 'Ghost Red Button', 'yit' );
    ...
    function yit_add_field_to_layout() {
        ...
        $args = array(
            ...
            'enable_dark_header'      => array(
                ...
                'desc'  => __( 'Set YES to change the style of typography in header, useful if you are using the transparent header and you have a dark static image.', 'yit' ),
                'type'  => 'onoff',
                'std'   => 'no'
            )
        );
...
if ( ! function_exists( 'yit_slogan_background' ) ) {
    ...
    function yit_slogan_background() {
        ...
        $custom_css = '#slogan .slogan-wrapper{' . implode( ' ', $css ) . '}'; ?>
...
if( ! function_exists('yit_contact_form_buttons_style') ){
    ...
    */
    ...
    function yit_contact_form_buttons_style(){
        return array(
            'flat'          => __( 'Black Flat', 'yit' ),
            'ghost'         => __( 'Ghost Black', 'yit' ),    
            'ghost-white'   => __( 'Ghost White', 'yit' ),
            'ghost-red'     => __( 'Ghost Red', 'yit' ),
            'ghost-grey'    => __( 'Ghost Grey', 'yit' )
        );
    }
}
    ...
    function yit_team_add_fields(){
        ...
        return array(
            ...
            'phone' => array(
                'label' => __( 'Phone', 'yit' ),
                'type'  => 'text',
                'desc'  => __( 'Insert phone number', 'yit' ),
                'std'   => ''
            ),
